(() => {
    ...
    Parallax.Each = class {
        ...
        animationFrame() {
            ...
            if (positionParent.top < 10 && positionParent.bottom > -10) switch (centerPoint) {
              case "top":
    ...
    new CountUp(priceEl, priceNum, {
        decimalPlaces: 2,
        prefix: "$",
        duration: 3,
        enableScrollSpy: true
    });
    new CountUp(volumeEl, volumeNum, {
        prefix: "$",
        duration: 3,
        enableScrollSpy: true
    });
    new CountUp(marketEl, marketNum, {
        prefix: "$",
        duration: 3,
        enableScrollSpy: true
    });
    new CountUp(circulationEl, circulationNum, {
        decimalPlaces: 2,
        duration: 3,
        enableScrollSpy: true
    });
    new CountUp(millionEl, millionNum, {
        prefix: "$",
        suffix: " million",
        duration: 3,
        enableScrollSpy: true
    });
    new CountUp(usersEl, usersNnum, {
        suffix: " users",
        duration: 3,
        enableScrollSpy: true
    });
    new CountUp(totalEl, totalNum, {
        duration: 3,
        enableScrollSpy: true
    });
    new CountUp(liquidityEl, liquidityNum, {
        duration: 3,
        prefix: "$",
        enableScrollSpy: true
    });
    new CountUp(boughtEl, boughtNum, {
        duration: 3,
        enableScrollSpy: true
    });
    const shuffle = array => {
    ...
    dotsArr.forEach(((dot, index) => {
        dot.style.transitionDelay = `${.02 * index}s`;
    }));
})();